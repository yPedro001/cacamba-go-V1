-- =====================================================
-- MIGRATION: CTR - Transação Atômica para Emissão
-- Created: 2026-04-15
-- =====================================================
...
BEGIN
  ...
  INSERT INTO ctrs (
    ...
    destinatario_cidade,
    destinatario_uf,
    destinatario_tipo_local,
    destinatario_licenca,
    ...
    declaracao_transportador_nome,
    declaracao_transportador_assinatura,
    declaracao_recebedor_nome,
    declaracao_recebedor_assinatura,
    declaracao_recebedor_data_hora,
    declaracao_recebedor_carimbo,
    declaracao_recebedor_observacao,
    ...
    p_data::DATE,
    p_hora_saida::TIME,
    p_tipo_operacao::ctr_tipo_operacao,
    ...
    p_destinatario_uf::ctr_uf,
    p_destinatario_tipo_local::ctr_tipo_local_descarte,
    p_destinatario_licenca,
    
    p_residuo_classe::ctr_residuo_classe,
    p_residuo_descricao,
    p_residuo_acondicionamento,
    p_residuo_quantidade,
    p_residuo_unidade::ctr_residuo_unidade,
    ...
    p_declaracao_recebedor_data_hora,
