...
import { useMapController, MAP_COLORS } from '@/features/map'
...
// MapComponent cannot be SSR rendered due to leaflet relying on window
const Map = dynamic(() => import('@/features/map').then(m => m.MapComponent), { 
  ssr: false, 
  loading: () => <div className="h-[calc(100vh-180px)] w-full flex items-center justify-center bg-muted/20 border border-border rounded-xl">Carregando Mapa Corporativo...</div> 
})
